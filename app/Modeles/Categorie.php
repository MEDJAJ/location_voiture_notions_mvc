...
class Categorie {
    ...
    public static function modifierCategorie( $id,$nom,$description,$status,$image) {
          $conn = Database::getInstance()->getConnection();
...
public static function getNamesC(){
      $conn = Database::getInstance()->getConnection();
...
public static function getNomCparId($id){
      $conn = Database::getInstance()->getConnection();
...
public static function countCategorieDisponble(){
      $conn = Database::getInstance()->getConnection();
...
public static function countCategorieIndisponible(){
      $conn = Database::getInstance()->getConnection();
