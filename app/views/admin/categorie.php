...
<aside class="w-72 sidebar-gradient text-white flex flex-col shadow-2xl overflow-hidden sticky top-0 h-screen">
    <div class="p-8">
        ...
        <nav class="space-y-2">
            ...
            <a href="/location_voiture_mvc/public/categorie" class="flex items-center gap-4 p-3 rounded-xl bg-indigo-600 shadow-lg shadow-indigo-600/30 font-semibold">
...
<main class="flex-1 p-10 overflow-y-auto">
    ...
    <section class="glass-card p-8 rounded-[2rem] shadow-sm mb-12 relative overflow-hidden">
        ...
        <form method="POST"  enctype="multipart/form-data" action="/location_voiture_mvc/public/ajouter_categorie">
...
?>
        ...
        <div class="bg-white rounded-[2rem] shadow-sm hover:shadow-2xl transition-all duration-300 border border-slate-100 group">
            <div class="relative h-56 m-3 overflow-hidden rounded-[1.5rem]">
                <img src="<?= '/location_voiture_mvc/app/assets/uploads/'.$c['image'] ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
...
<?php  } ?>
            ...
            <div class="p-6 pt-2">
                ...
                <div class="flex gap-3 mt-6">
                   <a href="/location_voiture_mvc/public/categorie_modifier?id=<?= $c['id_categorie'] ?>">
                   ...
                   <a href="/location_voiture_mvc/public/categorie_supprimer?id=<?= $c['id_categorie'] ?>">
