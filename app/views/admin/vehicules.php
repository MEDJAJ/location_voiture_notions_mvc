...
<aside class="w-72 sidebar-gradient text-white flex flex-col shadow-2xl overflow-hidden sticky top-0 h-screen">
    <div class="p-8">
        ...
        <nav class="space-y-2">
            ...
            <a href="/location_voiture_mvc/public/vehicule_categorie_admin" class="flex items-center gap-4 p-3 rounded-xl bg-indigo-600 shadow-lg shadow-indigo-600/30 font-semibold">
            ...
            <a href="/location_voiture_mvc/public/afficher_avis" class="flex items-center gap-4 p-3 rounded-xl transition-all duration-200 hover:bg-white/10 group">
...
<main class="flex-1 p-10 overflow-y-auto">
    ...
    <section class="glass-card p-8 rounded-[2rem] shadow-sm mb-12 relative overflow-hidden">
        ...
        <form method="POST" action="/location_voiture_mvc/public/ajauter_vehicule" enctype="multipart/form-data" id="vehicleFormContainer" class="grid grid-cols-1 gap-8 relative z-10" >
    ...
    ?>
                            <div class="bg-white rounded-[2rem] shadow-sm hover:shadow-2xl transition-all duration-300 border border-slate-100 group">
                                 <div class="relative h-56 m-3 overflow-hidden rounded-[1.5rem]"> 
                                    <img src="<?= '/location_voiture_mvc/app/assets/uploads/'.$vehicule['image'] ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"> 
                                                ...
                                                <div class="flex justify-between items-start mb-4">
                                                     <div> <span class="text-xs font-bold text-indigo-500 uppercase tracking-widest"><?= $vehicule['modele'] ?></span>
                                                      <h4 class="text-xl font-bold text-slate-800"><?= $vehicule['marque'] ?></h4> </div> 
                                                       ...
                                                       <h4 class="text-xs font-bold text-indigo-500 uppercase tracking-widest">categorie :<?= $vehicule['categorie_nom'] ?></h4> </div> 
                   ...
                   <a href=" /location_voiture_mvc/public/modifier_vehicule?id=<?= $vehicule['id_vehicule'] ?>">
                   ...
                   <a href="/location_voiture_mvc/public/supprimer_vehicule?id=<?= $vehicule['id_vehicule'] ?>">
