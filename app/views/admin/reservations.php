...
<aside class="w-72 sidebar-gradient text-white flex flex-col shadow-2xl overflow-hidden sticky top-0 h-screen">
    <div class="p-8">
        ...
        <nav class="space-y-2">
            ...
            <a href="/location_voiture_mvc/public/reservations" class="flex items-center gap-4 p-3 rounded-xl bg-indigo-600 shadow-lg shadow-indigo-600/30 font-semibold">
                ...
                <tr class="hover:bg-indigo-50/30 transition-all group">
                    ...
                    <td class="p-6 text-right">
                        <div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-all">
                          ...
                          <a href="/location_voiture_mvc/public/modifier_reservation?id=<?= $reservation['id_reservation'] ?>">
                            ...
                            <a href="/location_voiture_mvc/public/supprimer_reservation?id=<?= $reservation['id_reservation'] ?>">
                    ...
                    <td class="p-6 text-right">
                        <div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-all">
                            <a href="/location_voiture_mvc/public/changer_status_reservation?id=<?=$reservation['id_reservation'] ?>">
