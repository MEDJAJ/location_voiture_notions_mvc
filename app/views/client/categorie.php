...
<body class="bg-slate-50">
    <nav class="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 px-6 py-4 flex justify-between items-center">
        ...
        <div class="hidden md:flex gap-8 font-bold text-gray-600">
            <a href="/location_voiture_mvc/public/categorie" class="text-indigo-600">Nos Catégories</a>
            <a href="/location_voiture_mvc/public/avis" class="hover:text-indigo-600">Mes Avis</a>
        </div>
        ...
        ?>
            ...
            <div class="group relative bg-white rounded-[2.5rem] p-4 border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden">
                <div class="relative h-64 rounded-[2rem] overflow-hidden mb-6">
                    <img src="<?= '/location_voiture_mvc/app/assets/uploads/'.$categorie['image'] ?>" class="w-full h-full object-cover group-hover:scale-110 transition duration-700">
                ...
                <div class="px-4 pb-4">
                    ...
                    <a href="/location_voiture_mvc/public/vehicule?id=<?= $categorie['id_categorie']?>&name=<?= $categorie['nom'] ?>" class="flex items-center justify-between group/btn bg-slate-50 hover:bg-indigo-600 p-4 rounded-2xl transition-all duration-300">
