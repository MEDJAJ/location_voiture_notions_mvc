...
<body class="bg-slate-50">
    <nav class="bg-white border-b px-6 py-4 flex justify-between items-center">
        ...
        <div class="flex gap-6">
            <a href="/location_voiture_mvc/public/categorie" class="font-bold text-gray-400">Catalogue</a>
            <a href="#" class="font-bold text-indigo-600">Mes Avis</a>
        </div>
    </nav>
            ...
            <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 flex flex-col md:flex-row justify-between items-center gap-6">
                <div class="flex gap-6 items-center w-full">
                    <div class="w-24 h-24 bg-gray-100 rounded-2xl overflow-hidden shrink-0">
                        <img src="<?= '/location_voiture_mvc/app/assets/uploads/'.$aviuser['image'] ?>" class="w-full h-full object-cover">
                    </div>
                    <div>
...
?>
                ...
                <div class="flex gap-3 w-full md:w-auto justify-end">
                    ...
                    <a href="/location_voiture_mvc/public/modifier?id=<?= $aviuser['id_avis'] ?>">
                  <button class="px-4 py-3 bg-indigo-50 text-indigo-600 rounded-xl font-bold hover:bg-indigo-100 transition">Modifier</button>
                    </a>
                     <a href="/location_voiture_mvc/public/supprimer?id=<?= $aviuser['id_avis'] ?>">
...
<a href="/location_voiture_mvc/public/restaurer?id=<?= $aviuser['id_avis'] ?>">
...
<?php    }  } } ?>
 ...
 <h2 class="text-2xl font-bold mb-6 ">Ajouter un avis</h2>
            ...
            <?php   } ?>
            <form action="/location_voiture_mvc/public/ajauter" class="space-y-4" method="POST">
