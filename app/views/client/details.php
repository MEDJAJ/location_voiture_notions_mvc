...
<body class="bg-slate-50">
    <nav class="bg-white border-b px-6 py-4 flex justify-between items-center">
        ...
        <a href="/location_voiture_mvc/public/categorie" class="text-sm font-bold text-gray-500 hover:text-indigo-600">← Retour au catalogue</a>
    </nav>

    <main class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div class="lg:col-span-2">
            <div class="rounded-[3rem] overflow-hidden shadow-lg mb-8 bg-gray-200">
                <img src="<?= '/location_voiture_mvc/app/assets/uploads/'.$vehicules['image'] ?>" class="w-full h-[500px] object-cover">
            </div>
 ...
 <div class="space-y-6">
    <div class="bg-white p-6 rounded-3xl border border-gray-100">
        ...
        <a href="/location_voiture_mvc/public/avis"
...
<h3 class="text-2xl font-bold mb-8 italic ">Réserver ce véhicule</h3>
                 <?php  }  ?>
                <form action="/location_voiture_mvc/public/ajauter_reservation?id=<?= $vehicules['id_vehicule'] ?>&id_c=<?= $id_c ?>" class="space-y-5" method="POST">
                    <div>
