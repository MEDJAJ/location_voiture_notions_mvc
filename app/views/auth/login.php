...
<?php }  ?>
                ...
                <div class="mt-10 pt-8 border-t border-slate-200/60 dark:border-slate-700 text-center font-medium">
                    <p class="text-slate-500 dark:text-slate-400">
                        Nouveau conducteur ? 
                        <a href="../../location_voiture_mvc/public/register" class="text-primary font-extrabold hover:text-blue-700 underline-offset-4 hover:underline ml-1">Créer un compte</a>
                    </p>
                </div>
            </div>
        </div>
